...
export declare type UnwrapRef<T> = T extends Ref<infer V>
  ...
  : T;
declare type UnwrapRef2<T> = T extends Ref<infer V>
  ? UnwrapRef3<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef3<T> = T extends Ref<infer V>
  ? UnwrapRef4<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef4<T> = T extends Ref<infer V>
  ? UnwrapRef5<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef5<T> = T extends Ref<infer V>
  ? UnwrapRef6<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef6<T> = T extends Ref<infer V>
  ? UnwrapRef7<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef7<T> = T extends Ref<infer V>
  ? UnwrapRef8<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef8<T> = T extends Ref<infer V>
  ? UnwrapRef9<V>
  : T extends BailTypes
  ? T
  : T extends object
  ...
  : T;
declare type UnwrapRef9<T> = T extends Ref<infer V>
  ? UnwrapRef10<V>
  : T extends BailTypes
  ? T
  : T extends object
...
export declare function ref<S, T = unknown, R = HasDefined<S> extends true ? S : RefValue<T>>(
  raw: T
): Ref<R>;
